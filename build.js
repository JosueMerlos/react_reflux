  ...
  render: function render() {
    if (this.state.imagestore) {
      ...
      return _react2['default'].createElement(
        'p',
        null,
        'No hay imagenes del viejo lesbiano'
      );
    }
  }
});
...
},{"../stores/ImageStore":180,"react":161,"reflux":177}],4:[function(require,module,exports){
'use strict';
...
},{"eventemitter3":4}],174:[function(require,module,exports){
...
var ImageStore = _reflux2['default'].createStore({
  ...
  imagelist: [],
  url: 'https://api.flickr.com/services/feeds/photos_public.gne?format=json&per_page=8',
  init: function init() {
    this.fetchList();
  },
  fetchList: function fetchList() {
    var tags = ['meme', 'cats', 'food', 'nature', 'cities', 'blue', 'dog', 'studio', 'love', 'friend'];
